...
Lottery.prototype = {
    ...
    bindEvent: function() {
        ...
        if (!device) {
            ...
            _this.conNode.addEventListener('mouseup',
            function(e) {
                e.preventDefault();
            ...
            _this.conNode.addEventListener("touchmove",
            function(e) {
                if (isMouseDown) {
                    e.preventDefault();
                }
            ...
            false);
            _this.conNode.addEventListener('touchend',
            function(e) {
                isMouseDown = false;
                var per = _this.getTransparentPercent(_this.maskCtx, _this.width, _this.height);
                if (per >= 50) {
        ...
        // move事件来画点
        this.mask.addEventListener(clickEvtName,
        function(e) {
            e.preventDefault();
        ...
        this.mask.addEventListener(moveEvtName,
        function(e) {
            e.preventDefault();
